...
public class MerchantDao {
	...
	public Merchant verifyMerchant(long phone, String password) {
		Query q = manager.createQuery("select m fom Merchant m where m.phone=?1 and m.password=?2");
	...
	public Merchant verifyMerchant(String email, String password) {
		Query q = manager.createQuery("select m fom Merchant m where m.email=?1 and m.password=?2");
